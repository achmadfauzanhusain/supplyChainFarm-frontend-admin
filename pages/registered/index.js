    ...
    return (
        <>
            ...
            <div className="mt-8 md:mt-10 px-5 md:px-8 lg:px-18">
                ...
                <div className="mt-8">
                    <h1 className={`${urbanist.className} text-3xl sm:text-4xl md:text-5xl font-semibold`}>Registered</h1>
                ...
                <div className="mt-8 md:mt-10 grid grid-cols-2">
                    <Link href="/registered/07x4....6351" className="bg-[#BEE3F8]/25 hover:bg-[#0D6EFD] w-full px-6 py-6 rounded-md flex flex-col gap-5 transition-all duration-300">
                        <div>
                            <h2 className="text-base sm:text-2xl md:text-3xl font-semibold">PT KOPI INDONESIA</h2>
