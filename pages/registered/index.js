        ...
        <>
            <div className="mt-10 md:mt-18 px-5 md:px-8 lg:px-18">
                ...
                <div className="mt-8 md:mt-10 grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                    {suppliers.map((s) => (
                    <Link key={s.ethWalletAddress} href={`/registered/${s.ethWalletAddress}`} className="bg-[#BEE3F8]/25 hover:bg-[#0D6EFD] w-full px-3 sm:px-4 md:px-6 py-4 md:py-6 rounded-md flex flex-col gap-5 transition-all duration-300">
                        <div>
